      ...
      <div className="w-full flex items-center justify-between">
        <div className=" flex items-center lg:gap-4">
          <div className="lg:hidden flex items-center gap-4 rounded-md ml-2">
            <div className=" bg-[#262630] lg:h-[50px] h-[45px] flex items-center justify-center lg:w-[50px] w-[45px] rounded-md">
              <MenuIcon />
            </div>
          </div>
          ...
          <div className="bg-[#E8E8E8] p-3 rounded-md flex items-center justify-center min-w-fit h-[45px] lg:h-[55px] gap-[10px]">
            <WalletIcon />
        ...
        <div className="flex gap-4 items-center">
          <button className="flex items-center bg-[#FF2A2A] p-[15px] w-[45px] h-[45px] lg:w-fit lg:h-fit rounded-md text-white">
            <LogoutIcon />
            <p className="hidden lg:block">برگشت به وبسایت</p>
          </button>
          <button className="relative p-[15px] rounded-md bg-[#E8E8E8] w-[45px] flex items-center justify-center h-[45px] lg:w-fit lg:h-fit">
