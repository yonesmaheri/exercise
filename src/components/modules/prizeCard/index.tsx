  ...
  return (
    ...
    >
      <div className="flex sm:items-center sm:justify-between w-full lg:w-fit gap-4">
        ...
        <div className="bg-[#F0F0F0] font-bold w-full rounded-xl p-3 lg:hidden flex items-center">
          خرید از فروشگاه زنجیره ای رفاه
        </div>
      </div>

      <div className="flex flex-col justify-between h-full w-full lg:w-[357px] ">
        <div className="bg-[#F0F0F0] w-full hidden lg:block font-bold rounded-xl p-3">
          خرید از فروشگاه زنجیره ای رفاه
        </div>
        <div className="bg-[#565662] w-full flex items-center rounded-xl justify-between">
          <div className=" text-white p-3 w-[50%] text-right font-bold">
            کد تخفیف خرید:
          </div>
          <div className=" bg-[#262630] font-bold py-3 px-6 text-white w-[50%] flex items-center justify-between rounded-xl text-center">
            <span>FGA6799AGK</span>
            <DocumentIcon />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-between h-full gap-4 lg:gap-0 w-full lg:w-[285px]">
        <div className="bg-[#565662] w-full flex items-center rounded-xl justify-between">
          <div className="font-bold text-white p-3 w-[40%] text-right">مبلغ تخفیف:</div>
          <div className="font-bold bg-[#262630] py-3 px-6 text-white w-[60%] flex items-center justify-center rounded-xl text-center">
            <span>550000 تومان</span>
          </div>
        </div>
        <div className="bg-[#565662] w-full flex items-center rounded-xl justify-between">
          <div className="font-bold text-white p-3 w-[60%] text-right">
            امتیاز مورد نیاز:
          </div>
          <div className="font-bold bg-[#262630] py-3 px-6 text-white w-[40%] flex items-center justify-center rounded-xl text-center">
            <span>70 امتیاز</span>
          </div>
        </div>
      </div>
